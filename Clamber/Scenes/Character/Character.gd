...
func _process(_delta: float) -> void:
	_x_direction = Input.get_action_strength("ui_right") - Input.get_action_strength("ui_left")	
...
func _handle_rocket_pack_state() -> void:
	if Input.is_action_pressed("rocket") and !_rocket_pack_empty:		
